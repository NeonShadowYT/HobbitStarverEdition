...
> [!NOTE]
> Ещё разрабатывается, чтобы поддерживать игру в актуальном состоянии и не перекачивать все каждый раз, используй GitHub Desktop, добавь этот репозиторий используя его ссылку, жми Fetch origin чтобы обновить только все измененные файлы.
